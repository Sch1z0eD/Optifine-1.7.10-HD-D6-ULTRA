...
public class ImageBufferDownload implements IImageBuffer {
    ...
    public static final String __OBFID = "CL_00000956";
    ...
    public void setAreaOpaque(int par1, int par2, int par3, int par4) {
        for (int var5 = par1; var5 < par3; ++var5) {
            for (int var6 = par2; var6 < par4; ++var6) {
    ...
    public boolean hasTransparency(int par1, int par2, int par3, int par4) {
        for (int var5 = par1; var5 < par3; ++var5) {
            for (int var6 = par2; var6 < par4; ++var6) {
