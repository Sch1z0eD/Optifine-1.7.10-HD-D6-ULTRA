...
public class CustomItems {
   ...
   public static void updateIcons(TextureMap textureMap, IResourcePack rp) {
      ...
      for(int var14 = 0; var14 < names.length; ++var14) {
         ...
         Config.dbg("patch.CustomItems: " + name);
         ...
         try {
            ...
            if(e == null) {
               ...
               if(in == null) {
                  Config.warn("patch.CustomItems file not found: " + name);
                  continue;
               }
   ...
   public static Map makeAutoImageProperties(IResourcePack rp) {
   ...
   public static Map makePotionImageProperties(IResourcePack rp, boolean splash) {
      HashMap map = new HashMap();
   ...
   public static Properties makePotionProperties(String name, boolean splash, String path) {
      int potionItemId;
   ...
   public static int[] getPotionIds(int baseId) {
      return new int[]{baseId, baseId + 16, baseId + 32, baseId + 48};
   }

   public static int getPotionNameDamage(String name) {
   ...
   public static List makePropertyList(CustomItemProperties[][] propsArr) {
   ...
   public static CustomItemProperties[][] propertyListToArray(List list) {
   ...
   public static void addToItemList(CustomItemProperties cp, List itemList) {
      if(cp.items != null) {
   ...
   public static void addToList(CustomItemProperties cp, List list, int id) {
      while(id >= list.size()) {
   ...
   public static IIcon getCustomPotionTexture(CustomItemProperties cip, ItemPotion item, int damage) {
      if(cip.damage != null) {
         if(cip.damageMask != 0) {
   ...
   public static IIcon getCustomItemTexture(CustomItemProperties cip, ItemStack itemStack, IIcon icon) {
      Item item = itemStack.getItem();
      if(cip.damage != null) {
