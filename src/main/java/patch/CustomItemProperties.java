...
public class CustomItemProperties {
   ...
   public int[] parseItems(String str, String str2) {
      if(str == null) {
         str = str2;
      }
   ...
   public static String parseTexture(String texStr, String texStr2, String texStr3, String path, String basePath) {
      if(texStr == null) {
         texStr = texStr2;
      }
   ...
   public static Map parseTextures(Properties props, String basePath) {
   ...
   public static String fixTextureName(String iconName, String basePath) {
   ...
   public NbtTagValue[] parseNbtTagValues(Properties props) {
   ...
   public static Map getMatchingProperties(Properties props, String keyPrefix) {
   ...
   public static IIcon registerIcon(String tileName, TextureMap textureMap) {
      if(tileName == null) {
         return null;
      } else {
