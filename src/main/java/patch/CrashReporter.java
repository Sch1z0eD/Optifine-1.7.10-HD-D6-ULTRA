...
public class CrashReporter {
   ...
   public static String makeReport(CrashReport crashReport) {
   ...
   public static String makeSummary(CrashReport crashReport) {
   ...
   public static void extendCrashReport(CrashReportCategory cat) {
      ...
      if(Config.getGameSettings() != null) {
         ...
         cat.addCrashSection("patch.Mipmaps", "" + Config.getMipmapLevels());
