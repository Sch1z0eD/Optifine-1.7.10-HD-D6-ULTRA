...
public class DynamicLight {
   ...
   public Set setLitChunkPos = new HashSet();
   ...
   public EnumFacing getOpposite(EnumFacing facing) {
   ...
   public static BlockPos getRenderChunk(BlockPos pos, EnumFacing facing) {
   ...
   public void updateChunkLight(RenderGlobal renderGlobal, BlockPos pos, Set setPrevPos, Set setNewPos) {
      if(pos != null) {
   ...
   // $FF: synthetic class
   public static class NamelessClass297189670 {
