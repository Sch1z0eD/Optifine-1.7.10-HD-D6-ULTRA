...
public class StrUtils {
   ...
   public static boolean equalsMaskSingle(String str, String mask, char wildCharSingle) {
   ...
   public static int indexOfMaskSingle(String str, String mask, int startPos, char wildCharSingle) {
      if(str != null && mask != null) {
   ...
   public static boolean endsWithMaskSingle(String str, String mask, char wildCharSingle) {
      if(str != null && mask != null) {
         if(str.length() < mask.length()) {
            return false;
         } else {
   ...
   public static boolean startsWithMaskSingle(String str, String mask, char wildCharSingle) {
      if(str != null && mask != null) {
         if(str.length() < mask.length()) {
            return false;
         } else {
   ...
   public static boolean equals(char ch, String matches) {
