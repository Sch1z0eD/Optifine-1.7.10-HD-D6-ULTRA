...
public class TextureManager implements ITickable, IResourceManagerReloadListener {
    ...
    public final Map mapResourceLocations = Maps.newHashMap();
    public final List listTickables = Lists.newArrayList();
    public final Map mapTextureCounters = Maps.newHashMap();
    public IResourceManager theResourceManager;
    public static final String __OBFID = "CL_00001064";
    ...
    public boolean loadTexture(ResourceLocation par1ResourceLocation, final ITextureObject par2TextureObject) {
        ...
        try {
            ...
            var6.addCrashSectionCallable("Texture object class", new Callable() {
                ...
                public static final String __OBFID = "CL_00001065";
