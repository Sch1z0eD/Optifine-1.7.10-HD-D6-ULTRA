...
public class EntityRenderer implements IResourceManagerReloadListener {
                ...
                if (var15.canBeCollidedWith()) {
                    ...
                    if (var17.isVecInside(var6)) {
                        ...
                        if (var19 < var12 || var12 == 0.0D) {
                            boolean canRiderInteract = var15.canRiderInteract();
    ...
    public float getFOVModifier(float par1, boolean par2) {
    ...
    public void hurtCameraEffect(float par1) {
    ...
    public void setupViewBobbing(float par1) {
    ...
    public void orientCamera(float par1) {
        ...
        if (var2.isPlayerSleeping()) {
            ...
            if (!this.mc.gameSettings.debugCamEnable) {
                ...
                ForgeHooksClient.orientBedCamera(this.mc, var2);
            ...
            if (this.mc.gameSettings.debugCamEnable) {
                ...
                var29 = this.prevDebugCamPitch + (this.debugCamPitch - this.prevDebugCamPitch) * par1;
                ...
                var29 = var2.rotationPitch;
                if (this.mc.gameSettings.thirdPersonView == 2) {
                    var29 += 180.0F;
                }

                double var14 = (double) (-MathHelper.sin(var28 / 180.0F * 3.1415927F) * MathHelper.cos(var29 / 180.0F * 3.1415927F)) * var27;
                double var16 = (double) (MathHelper.cos(var28 / 180.0F * 3.1415927F) * MathHelper.cos(var29 / 180.0F * 3.1415927F)) * var27;
                double var18 = (double) (-MathHelper.sin(var29 / 180.0F * 3.1415927F)) * var27;
                ...
                GL11.glRotatef(var2.rotationPitch - var29, 1.0F, 0.0F, 0.0F);
                GL11.glRotatef(var2.rotationYaw - var28, 0.0F, 1.0F, 0.0F);
                GL11.glTranslatef(0.0F, 0.0F, (float) (-var27));
                GL11.glRotatef(var28 - var2.rotationYaw, 0.0F, 1.0F, 0.0F);
                GL11.glRotatef(var29 - var2.rotationPitch, 1.0F, 0.0F, 0.0F);
            }
        } else {
    ...
    public void updateCameraAndRender(float par1) {
        ...
        if (!this.mc.skipRenderWorld) {
            ...
            if (this.mc.currentScreen != null) {
                ...
                try {
                    var12 = MinecraftForge.EVENT_BUS.post(new GuiScreenEvent.DrawScreenEvent.Pre(this.mc.currentScreen, var161, var171, par1));
                    ...
                    MinecraftForge.EVENT_BUS.post(new GuiScreenEvent.DrawScreenEvent.Post(this.mc.currentScreen, var161, var171, par1));
        ...
        for (int var13 = 0; var13 < 2; ++var13) {
            ...
            if (this.debugViewDirection == 0) {
                ...
                if (this.mc.objectMouseOver != null && var4.isInsideOfMaterial(Material.water) && var4 instanceof EntityPlayer && !this.mc.gameSettings.hideGUI) {
                    ...
                    if (!ForgeHooksClient.onDrawBlockHighlight(var5, var17, this.mc.objectMouseOver, 0, var17.inventory.getCurrentItem(), par1) && !this.mc.gameSettings.hideGUI) {
           ...
           // boolean renderFirstPersonHand = Reflector.callBoolean(Reflector.ForgeHooksClient_renderFirstPersonHand, new Object[]{this.mc.renderGlobal, Float.valueOf(par1), Integer.valueOf(var13)});
            boolean renderFirstPersonHand = ForgeHooksClient.renderFirstPersonHand(this.mc.renderGlobal, par1, var13);
    ...
    public void renderCloudsCheck(RenderGlobal par1RenderGlobal, float par2) {
    ...
    public void renderRainSnow(float par1) {
        ...
        IRenderHandler var41 = var2.getWeatherRenderer();

            if (var41 != null) {
                var41.render(par1, this.mc.theWorld, this.mc);
                return;
            }


        float var451 = this.mc.theWorld.getRainStrength(par1);
        if (var451 > 0.0F) {
            this.enableLightmap((double) par1);
            if (this.rainXCoords == null) {
                ...
                for (int var461 = 0; var461 < 32; ++var461) {
                    for (int var42 = 0; var42 < 32; ++var42) {
                        float var43 = (float) (var42 - 16);
                        float var44 = (float) (var461 - 16);
                        float var45 = MathHelper.sqrt_float(var43 * var43 + var44 * var44);
                        this.rainXCoords[var461 << 5 | var42] = -var44 / var45;
                        this.rainYCoords[var461 << 5 | var42] = var43 / var45;
                    }
                }
            }
            ...
            EntityLivingBase var471 = this.mc.renderViewEntity;
            WorldClient var48 = this.mc.theWorld;
            int var49 = MathHelper.floor_double(var471.posX);
            int var50 = MathHelper.floor_double(var471.posY);
            int var51 = MathHelper.floor_double(var471.posZ);
            ...
            OpenGlHelper.glBlendFunc(770, 771, 1, 0);
            GL11.glAlphaFunc(516, 0.1F);
            double var9 = var471.lastTickPosX + (var471.posX - var471.lastTickPosX) * (double) par1;
            double var11 = var471.lastTickPosY + (var471.posY - var471.lastTickPosY) * (double) par1;
            double var13 = var471.lastTickPosZ + (var471.posZ - var471.lastTickPosZ) * (double) par1;
            ...
            for (int var20 = var51 - var16; var20 <= var51 + var16; ++var20) {
                for (int var21 = var49 - var16; var21 <= var49 + var16; ++var21) {
                    int var22 = (var20 - var51 + 16) * 32 + var21 - var49 + 16;
                    float var23 = this.rainXCoords[var22] * 0.5F;
                    float var24 = this.rainYCoords[var22] * 0.5F;
                    BiomeGenBase var25 = var48.getBiomeGenForCoords(var21, var20);
                    if (var25.canSpawnLightningBolt() || var25.getEnableSnow()) {
                        int var26 = var48.getPrecipitationHeight(var21, var20);
                        int var27 = var50 - var16;
                        int var28 = var50 + var16;
                        if (var27 < var26) {
                            var27 = var26;
                        }
                        ...
                        if (var27 != var28) {
                            ...
                            float var32;
                            double var35;
                            if (var48.getWorldChunkManager().getTemperatureAtHeight(var31, var26) >= 0.15F) {
                                if (var18 != 0) {
                                    if (var18 >= 0) {
                                        var8.draw();
                                    }
                                ...
                                double var33 = (double) ((float) var21 + 0.5F) - var471.posX;
                                var35 = (double) ((float) var20 + 0.5F) - var471.posZ;
                                float var37 = MathHelper.sqrt_double(var33 * var33 + var35 * var35) / (float) var16;
                                float var38 = 1.0F;
                                var8.setBrightness(var48.getLightBrightnessForSkyBlocks(var21, var30, var20, 0));
                                var8.setColorRGBA_F(var38, var38, var38, ((1.0F - var37 * var37) * 0.5F + 0.5F) * var451);
                                ...
                                var35 = (double) ((float) var21 + 0.5F) - var471.posX;
                                double var47 = (double) ((float) var20 + 0.5F) - var471.posZ;
                                float var39 = MathHelper.sqrt_double(var35 * var35 + var47 * var47) / (float) var16;
                                float var40 = 1.0F;
                                var8.setBrightness((var48.getLightBrightnessForSkyBlocks(var21, var30, var20, 0) * 3 + 15728880) / 4);
                                var8.setColorRGBA_F(var40, var40, var40, ((1.0F - var39 * var39) * 0.3F + 0.5F) * var451);
                                var8.setTranslation(-var9 * 1.0D, -var11 * 1.0D, -var13 * 1.0D);
    ...
    public void updateFogColor(float par1) {
        WorldClient var2 = this.mc.theWorld;
        EntityLivingBase var3 = this.mc.renderViewEntity;
        ...
        if (this.mc.gameSettings.anaglyph) {
            ...
            EntityViewRenderEvent.FogColors event = new EntityViewRenderEvent.FogColors(this, var3, var21, par1, this.fogColorRed, this.fogColorGreen, this.fogColorBlue);
    ...
    public void setupFog(int par1, float par2) {
        ...
        if (par1 == 999) {
            ...
            EntityViewRenderEvent.FogDensity event = new EntityViewRenderEvent.FogDensity(this, var3, var5, par2, 0.1F);
            if (MinecraftForge.EVENT_BUS.post(event)) {
                float var7 = event.density;
                ...
                if (var3.isPotionActive(Potion.blindness)) {
                    var6 = 5.0F;
                    int var71 = var3.getActivePotionEffect(Potion.blindness).getDuration();
                    if (var71 < 20) {
                    ...
                    if (par1 < 0) {
                        ...
                        GL11.glFogf(2915, var6 * Config.getFogStart());
                        GL11.glFogf(2916, var6);
                    }
                   ...
                   // Reflector.postForgeBusEvent(Reflector.newInstance(Reflector.EntityViewRenderEvent_RenderFogEvent_Constructor, new Object[]{this, var3, var5, Float.valueOf(par2), Integer.valueOf(par1), Float.valueOf(var6)}));
                    MinecraftForge.EVENT_BUS.post(new EntityViewRenderEvent.RenderFogEvent(this, var3, var5, par2, par1, var6));
                }
            }
    ...
    public void showLagometer(long tickTimeNano, long chunkTimeNano) {
