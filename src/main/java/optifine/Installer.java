...
public class Installer {
    ...
    public static void updateLauncherJson(File dirMc, String mcVerOf) throws IOException, ParseException {
    ...
    public static void updateJson(File dirMcVers, String mcVerOf, File dirMcLib, String mcVer, String ofEd) throws IOException, ParseException {
    ...
    public static boolean installOptiFineLibrary(String mcVer, String ofEd, File dirMcLib, boolean selectTarget) throws Exception {
        ...
        if (selectTarget) {
            ...
            int fileBase = dirMc.showSaveDialog(null);
            if (fileBase != 0) {
                return false;
            }
    ...
    public static void copyMinecraftVersion(String mcVer, String mcVerOf, File dirMcVer) throws IOException {
    ...
    public static void showMessageVersionNotFound(String mcVer) {
    ...
    public static String getOptiFineVersion() throws IOException {
        InputStream in = Installer.class.getResourceAsStream("/patch.Config.class");
        if (in == null) {
    ...
    public static String getOptiFineVersion(ZipFile zipFile) throws IOException {
        ZipEntry zipEntry = zipFile.getEntry("patch.Config.class");
        if (zipEntry == null) {
