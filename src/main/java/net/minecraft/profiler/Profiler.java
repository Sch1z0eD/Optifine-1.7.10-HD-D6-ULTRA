...
public class Profiler {
    ...
    public final List sectionList = new ArrayList();
    public final List timestampList = new ArrayList();
    public boolean profilingEnabled;
    public String profilingSection = "";
    public final Map profilingMap = new HashMap();
    public static final String __OBFID = "CL_00001497";
    public boolean profilerGlobalEnabled = true;
    public boolean profilerLocalEnabled;
    public long startTickNano;
    public long timeTickNano;
    public long startUpdateChunksNano;
    ...
    public static final class Result implements Comparable {
        ...
        public static final String __OBFID = "CL_00001498";
