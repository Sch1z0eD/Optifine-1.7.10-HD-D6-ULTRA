...
public class Mipmaps {
   ...
   public int[][] mipmapDatas;
   public IntBuffer[] mipmapBuffers;
   ...
   public static Dimension[] makeMipmapDimensions(int width, int height, String iconName) {
      ...
      if(texWidth == width && texHeight == height) {
         ...
         Config.warn("patch.Mipmaps not possible (power of 2 dimensions needed), texture: " + iconName + ", dim: " + width + "x" + height);
   ...
   public int averageColor(int i, int j) {
   ...
   public static void allocateMipmapTextures(int width, int height, String name) {
      ...
      for(int i = 0; i < dims.length; ++i) {
         ...
         int mipHeight = dim.height;
         int level = i + 1;
         GL11.glTexImage2D(3553, level, 6408, mipWidth, mipHeight, 0, '\u80e1', '\u8367', (IntBuffer)null);
      }
