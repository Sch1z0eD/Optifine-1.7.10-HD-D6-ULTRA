...
public class TextureMap extends AbstractTexture implements ITickableTextureObject, IIconRegister {
    ...
    public final List listAnimatedSprites;
    public final Map mapRegisteredSprites;
    public final Map mapUploadedSprites;
    public final int textureType;
    public final String basePath;
    public int mipmapLevels;
    public int anisotropicFiltering;
    public final TextureAtlasSprite missingImage;
    public static final String __OBFID = "CL_00001058";
    public static TextureMap textureMapBlocks = null;
    public static TextureMap textureMapItems = null;
    public TextureAtlasSprite[] iconGrid;
    ...
    public static final boolean ENABLE_SKIP = Boolean.parseBoolean(System.getProperty("fml.skipFirstTextureLoad", "true"));
    ...
    public void loadTextureAtlas(IResourceManager par1ResourceManager) {
      ...
      //  Reflector.callVoid(Reflector.ForgeHooksClient_onTextureStitchedPre, new Object[]{this});
        ...
        while (var5.hasNext() && !this.skipFirst) {
            ...
            ResourceLocation sheetWidth = this.completeResourceLocation(var25, 0);
                    ...
                    if (var26 != null) {
                        ...
                        while (var182.hasNext()) {
                            ...
                            if (var30 > 0 && var30 < debugImage.length - 1 && debugImage[var30] == null) {
                                ResourceLocation var32 = this.completeResourceLocation(var25, var30);
        ...
        while (var251.hasNext() && !this.skipFirst) {
            ...
            try {
                ...
                var261.addCrashSectionCallable("Sprite name", new Callable() {
                    ...
                    public static final String __OBFID = "CL_00001059";
                ...
                var261.addCrashSectionCallable("Sprite size", new Callable() {
                    ...
                    public static final String __OBFID = "CL_00001060";
                ...
                var261.addCrashSectionCallable("Sprite frames", new Callable() {
                    ...
                    public static final String __OBFID = "CL_00001061";

                    public String call() {
                        return sheetWidth1.getFrameCount() + " frames";
                    }
                });
                var261.addCrashSection("Mipmap levels", Integer.valueOf(this.mipmapLevels));
    ...
    public boolean isItemAnimationActive(TextureAtlasSprite ts) {
    ...
    public boolean isAbsoluteLocationPath(String resPath) {
    ...
    public int getStandardTileSize(Collection icons) {
    ...
    public void updateIconGrid(int sheetWidth, int sheetHeight) {
        this.iconGridCountX = -1;
        this.iconGridCountY = -1;
        this.iconGrid = null;
    ...
    public boolean isTerrainAnimationActive(TextureAtlasSprite ts) {
    ...
    public BufferedImage makeDebugImage(int sheetWidth, int sheetHeight) {
    ...
    public void addDebugSprite(TextureAtlasSprite ts, BufferedImage image) {
    ...
    public void writeDebugImage(BufferedImage image, String pngPath) {
        try {
