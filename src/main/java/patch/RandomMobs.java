...
public class RandomMobs {
   ...
   public static RandomMobsProperties parseProperties(ResourceLocation propLoc, ResourceLocation resLoc) {
      try {
         ...
         Config.dbg("patch.RandomMobs: " + resLoc.getResourcePath() + ", variants: " + e);
         InputStream in = Config.getResourceStream(propLoc);
         if(in == null) {
            Config.warn("patch.RandomMobs properties not found: " + e);
            return null;
         } else {
         ...
         Config.warn("patch.RandomMobs file not found: " + resLoc.getResourcePath());
         return null;
   ...
   public static ResourceLocation[] getTextureVariants(ResourceLocation loc) {
      ...
      if(locMcp == null) {
         ...
         if(list.size() <= 1) {
            ...
            Config.dbg("patch.RandomMobs: " + loc.getResourcePath() + ", variants: " + var6.length);
            return var6;
         }
      }
   }
