...
public class MathHelper {
    ...
    public static float[] SIN_TABLE = new float[65536];
    ...
    public static final float sin(float par0) {
        return fastMath ? SIN_TABLE_FAST[(int) (par0 * 651.8986F) & 4095] : SIN_TABLE[(int) (par0 * 10430.378F) & '\uffff'];
    }

    public static final float cos(float par0) {
        return fastMath ? SIN_TABLE_FAST[(int) ((par0 + 1.5707964F) * 651.8986F) & 4095] : SIN_TABLE[(int) (par0 * 10430.378F + 16384.0F) & '\uffff'];
    }
