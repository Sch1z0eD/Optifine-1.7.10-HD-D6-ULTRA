...
public class PlayerManager {
    ...
    public static final Logger field_152627_a = LogManager.getLogger();
    public final WorldServer theWorldServer;
    public final List players = new ArrayList();
    public final LongHashMap playerInstances = new LongHashMap();
    public final List chunkWatcherWithPlayers = new ArrayList();
    public final List playerInstanceList = new ArrayList();
    ...
    public final int[][] xzDirectionsConst = new int[][]{{1, 0}, {0, 1}, {-1, 0}, {0, -1}};
    public static final String __OBFID = "CL_00001434";
    ...
    public boolean overlaps(int par1, int par2, int par3, int par4, int par5) {
        int var6 = par1 - par3;
        int var7 = par2 - par4;
    ...
    public class PlayerInstance {
        ...
        public void removePlayer(EntityPlayerMP par1EntityPlayerMP, boolean sendData) {
            if (this.playersWatchingChunk.contains(par1EntityPlayerMP)) {
                ...
                MinecraftForge.EVENT_BUS.post(new ChunkWatchEvent.UnWatch(this.chunkLocation, par1EntityPlayerMP));
                if (this.playersWatchingChunk.isEmpty()) {
        ...
        public void increaseInhabitedTime(Chunk par1Chunk) {
        ...
        public void sendTileToAllPlayersWatchingChunk(TileEntity p_151252_1_) {
            if (p_151252_1_ != null) {
