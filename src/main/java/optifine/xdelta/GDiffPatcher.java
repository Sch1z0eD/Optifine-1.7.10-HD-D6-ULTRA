...
public class GDiffPatcher {
    ...
    public static void runPatch(SeekableSource source, InputStream patch, OutputStream out) throws IOException, PatchException {
                ...
                while (patchIS.available() > 0) {
                    ...
                    switch (command) {
                        ...
                        case 249:
                            ...
                            copy(offset1, length1, source, outOS);
                            i1 += 4;
                            break;
                        case 250:
                            offset1 = patchIS.readUnsignedShort();
    ...
    public static void copy(long offset, int length, SeekableSource source, OutputStream output) throws IOException, PatchException {
    ...
    public static void append(int length, InputStream patch, OutputStream output) throws IOException {
        int res;
