...
public class HttpPipelineReceiver extends Thread {
   ...
   public HttpPipelineReceiver(HttpPipelineConnection httpPipelineConnection) {
      super("patch.HttpPipelineReceiver");
   ...
   public HttpResponse readResponse(InputStream in) throws IOException {
   ...
   public byte[] readContentChunked(InputStream in) throws IOException {
   ...
   public void readFull(byte[] buf, InputStream in) throws IOException {
      int len;
