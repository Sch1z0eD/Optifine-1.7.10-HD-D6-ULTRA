...
public class RenderBlocks {
    ...
    public boolean renderBlockByRenderType(Block par1Block, int par2, int par3, int par4) {
        ...
        if (i == -1) {
            ...
            switch (i) {
                ...
                case 4:
                    return this.renderBlockLiquid(par1Block, par2, par3, par4);
                case 5:
                ...
                default:
                        ...
                        return FMLRenderAccessLibrary.renderWorldBlock(this, this.blockAccess, par2, par3, par4, par1Block, i);
    ...
    public boolean renderBlockBed(Block p_147773_1_, int p_147773_2_, int p_147773_3_, int p_147773_4_) {
        ...
        int var7 = p_147773_1_.getBedDirection(this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_);
        boolean var8 = p_147773_1_.isBedFoot(this.blockAccess, p_147773_2_, p_147773_3_, p_147773_4_);
    ...
    public boolean renderBlockBrewingStand(BlockBrewingStand p_147741_1_, int p_147741_2_, int p_147741_3_, int p_147741_4_) {
        ...
        IIcon var33 = this.getBlockIconFromSideAndMetadata(p_147741_1_, 0, 0);
        if (this.hasOverrideBlockTexture()) {
            var33 = this.overrideBlockTexture;
        }

        if (Config.isConnectedTextures() && this.overrideBlockTexture == null) {
            var33 = ConnectedTextures.getConnectedTexture(this.blockAccess, p_147741_1_, p_147741_2_, p_147741_3_, p_147741_4_, -1, var33);
        }

        double var32 = (double) var33.getMinV();
        double var13 = (double) var33.getMaxV();
        ...
        for (int var16 = 0; var16 < 3; ++var16) {
            ...
            double var19 = (double) var33.getInterpolatedU(8.0D);
            double var21 = (double) var33.getMaxU();
            if ((var15 & 1 << var16) != 0) {
                var21 = (double) var33.getMinU();
            }
    ...
    public boolean renderBlockCauldron(BlockCauldron p_147785_1_, int p_147785_2_, int p_147785_3_, int p_147785_4_) {
        ...
        IIcon var161 = BlockCauldron.getCauldronIcon("inner");
    ...
    public boolean renderBlockFlowerpot(BlockFlowerPot p_147752_1_, int p_147752_2_, int p_147752_3_, int p_147752_4_) {
        ...
        if (var211 != null && var211 instanceof TileEntityFlowerPot) {
            Item var221 = ((TileEntityFlowerPot) var211).getFlowerPotItem();
            int var14 = ((TileEntityFlowerPot) var211).getFlowerPotData();
    ...
    public boolean renderBlockTripWireSource(Block p_147723_1_, int p_147723_2_, int p_147723_3_, int p_147723_4_) {
        ...
        for (int var61 = 0; var61 < 6; ++var61) {
            ...
            var5.addVertexWithUV(var611.xCoord, var611.yCoord, var611.zCoord, var18, var24);
        ...
        float var621 = 0.09375F;
        float var39 = 0.09375F;
        float var40 = 0.03125F;
        var26[0] = Vec3.createVectorHelper((double) (-var621), 0.0D, (double) (-var39));
        var26[1] = Vec3.createVectorHelper((double) var621, 0.0D, (double) (-var39));
        var26[2] = Vec3.createVectorHelper((double) var621, 0.0D, (double) var39);
        var26[3] = Vec3.createVectorHelper((double) (-var621), 0.0D, (double) var39);
        var26[4] = Vec3.createVectorHelper((double) (-var621), (double) var40, (double) (-var39));
        var26[5] = Vec3.createVectorHelper((double) var621, (double) var40, (double) (-var39));
        var26[6] = Vec3.createVectorHelper((double) var621, (double) var40, (double) var39);
        var26[7] = Vec3.createVectorHelper((double) (-var621), (double) var40, (double) var39);
        ...
        for (int var45 = 0; var45 < 6; ++var45) {
            if (var45 == 0) {
                ...
                var32 = var26[2];
                var33 = var26[3];
                var18 = (double) var17.getInterpolatedU((double) var631);
        ...
        if (var8) {
            ...
            double var52 =  var17.getInterpolatedV(var8 ? 2.0D : 0.0D);
            double var54 = var17.getMaxU();
            double var56 =  var17.getInterpolatedV(var8 ? 4.0D : 2.0D);
    ...
    public boolean renderBlockRedstoneWire(Block p_147788_1_, int p_147788_2_, int p_147788_3_, int p_147788_4_) {
        ...
        if (rsColor != -1) {
            int red = rsColor >> 16 & 255;
            int green = rsColor >> 8 & 255;
            int blue = rsColor & 255;
            var12 = (float) red / 255.0F;
            var13 = (float) green / 255.0F;
            var14 = (float) blue / 255.0F;
        }
    ...
    public boolean renderBlockStainedGlassPane(Block block, int x, int y, int z) {
        ...
        Tessellator var6 = Tessellator.instance;
        var6.setBrightness(block.getMixedBrightnessForBlock(this.blockAccess, x, y, z));
        ...
        if (Config.isConnectedTextures() && this.overrideBlockTexture == null) {
            IIcon ix = ConnectedTextures.getConnectedTexture(this.blockAccess, block, x, y, z, 4, iconGlass1);
            IIcon iz = ConnectedTextures.getConnectedTexture(this.blockAccess, block, x, y, z, 3, iconGlass1);
            if (ix != iconGlass1 || iz != iconGlass1) {
        ...
        double gMinU = (double) iconGlass1.getMinU();
        double gHalf7U = (double) iconGlass1.getInterpolatedU(7.0D);
        ...
        boolean connZNeg = isStainedGlass1 ? ((BlockStainedGlassPane) block).canPaneConnectToBlock(this.blockAccess.getBlock(x, y, z - 1)) : ((BlockPane) block).canPaneConnectToBlock(this.blockAccess.getBlock(x, y, z - 1));
        boolean connZPos = isStainedGlass1 ? ((BlockStainedGlassPane) block).canPaneConnectToBlock(this.blockAccess.getBlock(x, y, z + 1)) : ((BlockPane) block).canPaneConnectToBlock(this.blockAccess.getBlock(x, y, z + 1));
        boolean connXNeg = isStainedGlass1 ? ((BlockStainedGlassPane) block).canPaneConnectToBlock(this.blockAccess.getBlock(x - 1, y, z)) : ((BlockPane) block).canPaneConnectToBlock(this.blockAccess.getBlock(x - 1, y, z));
        boolean connXPos = isStainedGlass1 ? ((BlockStainedGlassPane) block).canPaneConnectToBlock(this.blockAccess.getBlock(x + 1, y, z)) : ((BlockPane) block).canPaneConnectToBlock(this.blockAccess.getBlock(x + 1, y, z));
        double var58 = 0.001D;
        double var60 = 0.999D;
        double var62 = 0.001D;
        ...
        if (!connXNeg && !disconnected) {
            if (!connZNeg && !connZPos) {
                var6.addVertexWithUV(xHalfMin, yTop, zHalfMin, gHalf7U, gMinV);
                var6.addVertexWithUV(xHalfMin, yBottom, zHalfMin, gHalf7U, gMaxV);
        ...
        if ((connXPos || disconnected) && !connXNeg) {
            ...
            var6.addVertexWithUV(xHalfMax, yTop, zHalfMax, gHalf7U, gMinV);
            var6.addVertexWithUV(xHalfMax, yBottom, zHalfMax, gHalf7U, gMaxV);
        ...
        if (!connZNeg && !disconnected) {
            ...
            if (!connXNeg) {
                var6.addVertexWithUV(xHalfMin, yTop, z0, gMinU, gMinV);
                var6.addVertexWithUV(xHalfMin, yBottom, z0, gMinU, gMaxV);
            ...
            if (!connXPos) {
                ...
                var6.addVertexWithUV(xHalfMax, yBottom, z0, gMinU, gMaxV);
                var6.addVertexWithUV(xHalfMax, yTop, z0, gMinU, gMinV);
            } else {
                var6.addVertexWithUV(xHalfMax, yTop, zHalfMin, gHalf7U, gMinV);
                var6.addVertexWithUV(xHalfMax, yBottom, zHalfMin, gHalf7U, gMaxV);
                var6.addVertexWithUV(xHalfMax, yBottom, z0, gMinU, gMaxV);
                var6.addVertexWithUV(xHalfMax, yTop, z0, gMinU, gMinV);
                var6.addVertexWithUV(xHalfMax, yTop, z1, gMaxU, gMinV);
                var6.addVertexWithUV(xHalfMax, yBottom, z1, gMaxU, gMaxV);
        ...
        if (disconnected) {
            var6.addVertexWithUV(x0, yTop, zHalfMin, gHalf7U, gMinV);
            var6.addVertexWithUV(x0, yBottom, zHalfMin, gHalf7U, gMaxV);
            var6.addVertexWithUV(x0, yBottom, zHalfMax, gHalf9U, gMaxV);
            var6.addVertexWithUV(x0, yTop, zHalfMax, gHalf9U, gMinV);
            var6.addVertexWithUV(x1, yTop, zHalfMax, gHalf7U, gMinV);
            var6.addVertexWithUV(x1, yBottom, zHalfMax, gHalf7U, gMaxV);
    ...
    public boolean renderBlockStem(Block p_147724_1_, int p_147724_2_, int p_147724_3_, int p_147724_4_) {
        ...
        int var141 = var5.getState(this.blockAccess, p_147724_2_, p_147724_3_, p_147724_4_);
        if (var141 < 0) {
    ...
    public boolean renderBlockLiquid(Block p_147721_1_, int p_147721_2_, int p_147721_3_, int p_147721_4_) {
        ...
        if (!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
            ...
            if (this.renderAllFaces || var10) {
                ...
                float var58 = (float) BlockLiquid.getFlowDirection(this.blockAccess, p_147721_2_, p_147721_3_, p_147721_4_, var22);
                if (var58 > -999.0F) {
                ...
                double var50;
                if (var58 < -999.0F) {
                    var36 = (double) var57.getInterpolatedU(0.0D);
                    ...
                    var54 = 8.0F;
                    var36 = (double) var57.getInterpolatedU((double) (8.0F + (-var53 - var52) * 16.0F));
                    ...
                    var50 = (double) var57.getInterpolatedV((double) (8.0F + (-var53 - var52) * 16.0F));
                }
                ...
                double diff = 3.90625E-5D;
                var5.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + var24, (double) (p_147721_4_ + 0), var36 + diff, var45 + diff);
                var5.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + var26, (double) (p_147721_4_ + 1), var39 + diff, var47 - diff);
                var5.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + var28, (double) (p_147721_4_ + 1), var41 - diff, var49 - diff);
                var5.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + var30, (double) (p_147721_4_ + 0), var43 - diff, var50 + diff);
                var5.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + var24, (double) (p_147721_4_ + 0), var36 + diff, var45 + diff);
                var5.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + var30, (double) (p_147721_4_ + 0), var43 - diff, var50 + diff);
                var5.addVertexWithUV((double) (p_147721_2_ + 1), (double) p_147721_3_ + var28, (double) (p_147721_4_ + 1), var41 - diff, var49 - diff);
                var5.addVertexWithUV((double) (p_147721_2_ + 0), (double) p_147721_3_ + var26, (double) (p_147721_4_ + 1), var39 + diff, var47 - diff);
            ...
            for (int var62 = 0; var62 < 4; ++var62) {
                ...
                IIcon var59 = this.getBlockIconFromSideAndMetadata(p_147721_1_, var62 + 2, var23);
                if (this.renderAllFaces || var12[var62]) {
                    if (var62 == 0) {
                        var39 = var24;
                        var41 = var30;
                    ...
                    var5.setBrightness(p_147721_1_.getMixedBrightnessForBlock(this.blockAccess, var63, p_147721_3_, var37));
                    float var56 = 1.0F;
                    var56 *= var62 < 2 ? var16 : var17;
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(Block p_147751_1_, int p_147751_2_, int p_147751_3_, int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_) {
        ...
        if (this.renderAllFaces || p_147751_1_.shouldSideBeRendered(this.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_, 0)) {
            ...
            if (var14 < 0) {
                var14 = p_147751_1_.getMixedBrightnessForBlock(this.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_);
            }
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block p_147736_1_, int p_147736_2_, int p_147736_3_, int p_147736_4_, float p_147736_5_, float p_147736_6_, float p_147736_7_) {
        ...
        if (this.renderAllFaces || p_147736_1_.shouldSideBeRendered(this.blockAccess, p_147736_2_, p_147736_3_ - 1, p_147736_4_, 0)) {
            if (var26 < 0) {
                var26 = p_147736_1_.getMixedBrightnessForBlock(this.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_);
            }
    ...
    public boolean renderBlockHopperMetadata(BlockHopper p_147799_1_, int p_147799_2_, int p_147799_3_, int p_147799_4_, int p_147799_5_, boolean p_147799_6_) {
        ...
        if (!p_147799_6_) {
            ...
            float var14 = (float) (var24 & 255) / 255.0F;
            if (EntityRenderer.anaglyphEnable) {
                float var15 = (var25 * 30.0F + var13 * 59.0F + var14 * 11.0F) / 100.0F;
                float var16 = (var25 * 30.0F + var13 * 70.0F) / 100.0F;
                float var17 = (var25 * 30.0F + var14 * 70.0F) / 100.0F;
                var25 = var15;
                var13 = var16;
                var14 = var17;
            }

            var7.setColorOpaque_F(var25, var13, var14);
        }

        IIcon var241 = BlockHopper.getHopperIcon("hopper_outside");
        IIcon var251 = BlockHopper.getHopperIcon("hopper_inside");
        var13 = 0.125F;
        if (p_147799_6_) {
            var7.startDrawingQuads();
            var7.setNormal(1.0F, 0.0F, 0.0F);
    ...
    public void renderFaceYNeg(Block p_147768_1_, double p_147768_2_, double p_147768_4_, double p_147768_6_, IIcon p_147768_8_) {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateBottom == 0) {
            NaturalProperties nps = NaturalTextures.getNaturalProperties(p_147768_8_);
            if (nps != null) {
    ...
    public void renderFaceYPos(Block p_147806_1_, double p_147806_2_, double p_147806_4_, double p_147806_6_, IIcon p_147806_8_) {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateTop == 0) {
            NaturalProperties nps = NaturalTextures.getNaturalProperties(p_147806_8_);
            if (nps != null) {
    ...
    public void renderFaceZNeg(Block p_147761_1_, double p_147761_2_, double p_147761_4_, double p_147761_6_, IIcon p_147761_8_) {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateEast == 0) {
            NaturalProperties nps = NaturalTextures.getNaturalProperties(p_147761_8_);
            if (nps != null) {
    ...
    public void renderFaceZPos(Block p_147734_1_, double p_147734_2_, double p_147734_4_, double p_147734_6_, IIcon p_147734_8_) {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateWest == 0) {
            NaturalProperties nps = NaturalTextures.getNaturalProperties(p_147734_8_);
            if (nps != null) {
    ...
    public void renderFaceXNeg(Block p_147798_1_, double p_147798_2_, double p_147798_4_, double p_147798_6_, IIcon p_147798_8_) {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateNorth == 0) {
            NaturalProperties nps = NaturalTextures.getNaturalProperties(p_147798_8_);
            if (nps != null) {
    ...
    public void renderFaceXPos(Block p_147764_1_, double p_147764_2_, double p_147764_4_, double p_147764_6_, IIcon p_147764_8_) {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateSouth == 0) {
            NaturalProperties nps = NaturalTextures.getNaturalProperties(p_147764_8_);
            if (nps != null) {
    ...
    public void renderBlockAsItem(Block p_147800_1_, int p_147800_2_, float p_147800_3_) {
        ...
        if (var6 != 0 && var6 != 31 && var6 != 39 && var6 != 16 && var6 != 26) {
           ...
           // Reflector.callVoid(Reflector.FMLRenderAccessLibrary_renderInventoryBlock, new Object[]{this, p_147800_1_, Integer.valueOf(p_147800_2_), Integer.valueOf(var6)});
            FMLRenderAccessLibrary.renderInventoryBlock(this, p_147800_1_, p_147800_2_, var6);
        } else {
            if (var6 == 16) {
                p_147800_2_ = 1;
            }
    ...
    public float getAmbientOcclusionLightValue(int i, int j, int k) {
        Block block = this.blockAccess.getBlock(i, j, k);
        return block.isBlockNormalCube() ? this.aoLightValueOpaque : 1.0F;
    }

    public IIcon fixAoSideGrassTexture(IIcon tex, int x, int y, int z, int side, float f, float f1, float f2) {
    ...
    public boolean hasSnowNeighbours(int x, int y, int z) {
    ...
    public void renderSnow(int x, int y, int z, double maxY) {
