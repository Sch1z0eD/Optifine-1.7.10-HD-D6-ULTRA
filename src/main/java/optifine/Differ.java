...
public class Differ {
    ...
    public static void process(File baseFile, File modFile, File diffFile) throws IOException, DeltaException, NoSuchAlgorithmException {
    ...
    public static File detectBaseFile(File modFile) throws IOException {
        ...
        if (ofVer == null) {
            ...
            if (mcVer == null) {
                ...
                return new File(dirMc, "versions/" + mcVer + "/" + mcVer + ".jar");
            }
        }
    }
}
