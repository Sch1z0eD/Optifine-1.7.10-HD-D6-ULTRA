...
public abstract class EntityLiving extends EntityLivingBase {
    ...
    public static final String __OBFID = "CL_00001550";
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound) {
        ...
        for (float equipmentDropChance : this.equipmentDropChances) {
            var61.appendTag(new NBTTagFloat(equipmentDropChance).copy());
        }
    ...
    public void despawnEntity() {
        ...
        if (this.persistenceRequired) {
            this.entityAge = 0;
        } else if ((this.entityAge & 31) == 31 && (result = ForgeEventFactory.canEntityDespawn(this)) != Event.Result.DEFAULT) {
