...
public class LongHashMap {
    ...
    public transient LongHashMap.Entry[] hashArray = new LongHashMap.Entry[1024];
    public transient int numHashElements;
    public int capacity;
    public final float percentUseable;
    public transient volatile int modCount;
    public static final String __OBFID = "CL_00001492";
    ...
    public static int hash(int par0) {
        par0 ^= par0 >>> 20 ^ par0 >>> 12;
        return par0 ^ par0 >>> 7 ^ par0 >>> 4;
    }

    public static int getHashIndex(int par0, int par1) {
        return par0 & par1 - 1;
    }
    ...
    public final LongHashMap.Entry getEntry(long par1) {
        int var3 = getHashedKey(par1);
    ...
    public void resizeTable(int par1) {
    ...
    public void copyHashTableTo(LongHashMap.Entry[] par1ArrayOfLongHashMapEntry) {
        LongHashMap.Entry[] var2 = this.hashArray;
    ...
    public final LongHashMap.Entry removeKey(long par1) {
        int var3 = getHashedKey(par1);
    ...
    public void createKey(int par1, long par2, Object par4Obj, int par5) {
    ...
    public static class Entry {
        ...
        public static final String __OBFID = "CL_00001493";


        public Entry(int par1, long par2, Object par4Obj, LongHashMap.Entry par5LongHashMapEntry) {
            this.value = par4Obj;
