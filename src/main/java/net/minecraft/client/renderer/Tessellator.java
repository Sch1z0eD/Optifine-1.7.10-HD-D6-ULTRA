...
public class Tessellator {
    ...
    public static final String __OBFID = "CL_00000960";
    public boolean renderingChunk;
    public static boolean littleEndianByteOrder = ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN;
