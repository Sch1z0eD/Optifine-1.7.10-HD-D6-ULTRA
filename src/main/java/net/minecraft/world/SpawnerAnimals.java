...
public final class SpawnerAnimals {
    ...
    public HashMap eligibleChunksForSpawning = new HashMap();
    public static final String __OBFID = "CL_00000152";
    public Map mapSampleEntitiesByClass = new HashMap();
    public int lastPlayerChunkX = Integer.MAX_VALUE;
    public int lastPlayerChunkZ = Integer.MAX_VALUE;


    public static ChunkPosition func_151350_a(World p_151350_0_, int p_151350_1_, int p_151350_2_) {
                                                ...
                                                if (canCreatureTypeSpawnAtLocation(var44, par1WorldServer, var19, var20, var21)) {
                                                    ...
                                                    if (par1WorldServer.getClosestPlayer((double) var26, (double) var27, (double) var28, 24.0D) == null) {
                                                        ...
                                                        if (var32 >= 576.0F) {
                                                            ...
                                                            Event.Result result = ForgeEventFactory.canEntitySpawn(var41, par1WorldServer, var26, var27, var28);

                                                            boolean canSpawn = result == Event.Result.ALLOW || result == Event.Result.DEFAULT && var41.getCanSpawnHere();
    ...
    public static boolean canCreatureTypeSpawnAtLocation(EnumCreatureType par0EnumCreatureType, World par1World, int par2, int par3, int par4) {
        if (par0EnumCreatureType.getCreatureMaterial() == Material.water) {
           ...
           // return Reflector.ForgeBlock_canCreatureSpawn.exists() && !Reflector.callBoolean(var5, Reflector.ForgeBlock_canCreatureSpawn, new Object[]{par0EnumCreatureType, par1World, Integer.valueOf(par2), Integer.valueOf(par3), Integer.valueOf(par4)}) ? false : var5 != Blocks.bedrock && !par1World.getBlock(par2, par3, par4).isNormalCube() && !par1World.getBlock(par2, par3, par4).getMaterial().isLiquid() && !par1World.getBlock(par2, par3 + 1, par4).isNormalCube();
            return  !var5.canCreatureSpawn(par0EnumCreatureType, par1World, par2, par3, par4) ? false : var5 != Blocks.bedrock && !par1World.getBlock(par2, par3, par4).isNormalCube() && !par1World.getBlock(par2, par3, par4).getMaterial().isLiquid() && !par1World.getBlock(par2, par3 + 1, par4).isNormalCube();
        }
    }
