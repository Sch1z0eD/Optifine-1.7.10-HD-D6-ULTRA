...
public class Stitcher {
    ...
    public final int mipmapLevelStitcher;
    public final Set setStitchHolders = new HashSet(256);
    public final List stitchSlots = new ArrayList(256);
    public int currentWidth;
    public int currentHeight;
    public final int maxWidth;
    public final int maxHeight;
    public final boolean forcePowerOf2;
    public final int maxTileDimension;
    public static final String __OBFID = "CL_00001054";
    ...
    public static int getMipmapDimension(int p_147969_0_, int p_147969_1_) {
        return (p_147969_0_ >> p_147969_1_) + ((p_147969_0_ & (1 << p_147969_1_) - 1) == 0 ? 0 : 1) << p_147969_1_;
    }

    public boolean allocateSlot(Stitcher.Holder par1StitchHolder) {
    ...
    public boolean expandAndAllocateSlot(Stitcher.Holder par1StitchHolder) {
    ...
    public static class Holder implements Comparable {
        ...
        public final TextureAtlasSprite theTexture;
        public final int width;
        public final int height;
        public final int mipmapLevelHolder;
        public boolean rotated;
        public float scaleFactor = 1.0F;
        public static final String __OBFID = "CL_00001055";
    ...
    public static class Slot {
        ...
        public static final String __OBFID = "CL_00001056";
