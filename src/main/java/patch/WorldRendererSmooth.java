...
public class WorldRendererSmooth extends WorldRenderer {
   ...
   public WrUpdateState updateState = new WrUpdateState();
                  ...
                  for(int z = zMin; z < zMax; ++z) {
                     for(int x = var27; x < xMax; ++x) {
                        ...
                        if(block.getMaterial() != Material.air) {
                           ...
                           boolean canRender = block.canRenderInPass(var31);
   ...
   public void preRenderBlocksSmooth(int renderpass) {
   ...
   public void postRenderBlocksSmooth(int renderpass, EntityLivingBase entityLiving, boolean updateFinished) {
