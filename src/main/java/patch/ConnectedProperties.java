...
public class ConnectedProperties {
   ...
   public String[] parseMatchTiles(String str) {
      if(str == null) {
         return null;
      } else {
   ...
   public static String parseBasePath(String path) {
      int pos = path.lastIndexOf(47);
      return pos < 0?"":path.substring(0, pos);
   }

   public static BiomeGenBase[] parseBiomes(String str) {
      if(str == null) {
         return null;
      } else {
   ...
   public static BiomeGenBase findBiome(String biomeName) {
   ...
   public String[] parseTileNames(String str) {
      if(str == null) {
         return null;
      } else {
         ArrayList list = new ArrayList();
   ...
   public static int parseSymmetry(String str) {
      if(str == null) {
         return 1;
   ...
   public static int parseFaces(String str) {
      if(str == null) {
         return 63;
      } else {
   ...
   public static int parseConnect(String str) {
      if(str == null) {
         return 0;
   ...
   public static int[] parseBlockIds(String str) {
      if(str == null) {
         return null;
      } else {
         ArrayList list = new ArrayList();
   ...
   public static int parseBlockId(String blockStr) {
   ...
   public boolean isValidCtm(String path) {
      if(this.tiles == null) {
   ...
   public boolean isValidHorizontal(String path) {
      if(this.tiles == null) {
   ...
   public boolean isValidVertical(String path) {
      if(this.tiles == null) {
   ...
   public boolean isValidHorizontalVertical(String path) {
      if(this.tiles == null) {
   ...
   public boolean isValidVerticalHorizontal(String path) {
      if(this.tiles == null) {
   ...
   public boolean isValidRandom(String path) {
   ...
   public int getAverage(int[] vals) {
      if(vals.length <= 0) {
         return 0;
      } else {
         int sum = 0;
   ...
   public boolean isValidRepeat(String path) {
      if(this.tiles == null) {
         Config.warn("Tiles not defined: " + path);
         return false;
   ...
   public boolean isValidFixed(String path) {
      if(this.tiles == null) {
         Config.warn("Tiles not defined: " + path);
         return false;
   ...
   public boolean isValidTop(String path) {
      if(this.tiles == null) {
   ...
   public static IIcon[] registerIcons(String[] tileNames, TextureMap textureMap) {
      if(tileNames == null) {
         return null;
      } else {
